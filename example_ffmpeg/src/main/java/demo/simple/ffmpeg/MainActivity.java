...
import com.lxy.ffmpeg.FFmpegLib;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String version = String.format("ffmpeg version == %s", FFmpegLib.getVersion());
...
//        Bitmap bitmap = Bitmap.createBitmap(getCover(path), 1080, 1920, Bitmap.Config.RGB_565);
        Bitmap bitmap = FFmpegLib.getVideoImage(path);
        if (bitmap == null) {
    ...
    private void exeCmd() {
        ...
        int result = FFmpegLib.exeCmd(cmdArr);
